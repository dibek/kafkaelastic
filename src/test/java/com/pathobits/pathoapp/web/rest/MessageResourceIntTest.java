...
public class MessageResourceIntTest {
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getCode()).isEqualTo(DEFAULT_CODE);
        assertThat(testMessage.getMessageBody()).isEqualTo(DEFAULT_MESSAGE_BODY);
        assertThat(testMessage.getDateInsert()).isEqualTo(DEFAULT_DATE_INSERT);
    ...
    @Test
    @Transactional
    public void checkMessageBodyIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageRepository.findAll().size();
        // set the field null
    ...
    public void updateMessage() throws Exception {
        ...
        Message testMessage = messageList.get(messageList.size() - 1);
        assertThat(testMessage.getCode()).isEqualTo(UPDATED_CODE);
        assertThat(testMessage.getMessageBody()).isEqualTo(UPDATED_MESSAGE_BODY);
        assertThat(testMessage.getDateInsert()).isEqualTo(UPDATED_DATE_INSERT);
